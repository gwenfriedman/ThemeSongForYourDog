...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Soundable",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


/// An object to encapsulate sound functionality.
SWIFT_CLASS("_TtC9Soundable5Sound")
...
@interface Sound (SWIFT_EXTENSION(Soundable)) <AVAudioPlayerDelegate>
